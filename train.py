...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="/home/lsl/111/yolov5-master_2/models/yolov5s_chuang12.yaml", help="model.yaml path")
    ...
    parser.add_argument("--device", default="1", help="cuda device, i.e. 1 or 1,2,3,4 or cpu")
