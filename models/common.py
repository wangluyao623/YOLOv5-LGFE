...
#         )
#         self.cv1 = nn.Conv2d(in_channels=2*in_channels, out_channels=in_channels, kernel_size=1, stride=1, padding=0)
#         self.cv2 = nn.Conv2d(in_channels=in_channels, out_channels=in_channels, kernel_size=3, stride=1, padding=1)
#         self.cv3 = nn.Conv2d(in_channels=in_channels, out_channels=in_channels, kernel_size=3, stride=1, padding=1)
...
#         super(MyFusionBlock, self).__init__()
#         self.aff1 = FDAF(in_planes)
#         self.fem1 = Frequedimy_Stage(in_planes)
#         self.aff2 = FDAF(in_planes)
#         self.fem2 = Frequedimy_Stage(in_planes)
#     def forward(self, x):
#         x1 = x[0]
#         x2 = x[1]
